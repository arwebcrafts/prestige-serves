  ...
  return `
    ...
    <div class="form-group">
      ...
      <select name="serviceType" required="">
        ...
        <option value="eRecording Service — $85.00">eRecording Service — $85.00</option>
    ...
    <div class="form-group"><label>Deadline Date</label><input type="date" name="deadlineDate" id="req-deadlineDate" data-min-tomorrow></div>
    <div class="form-group">
      ...
      <div class="file-upload-area" onclick="this.querySelector('input').click()">
        <input type="file" id="file-input" name="files" style="display:none;" multiple accept=".pdf,.doc,.docx,.jpg,.jpeg,.png">
        <span id="file-upload-text">+ Add Files</span>
      </div>
      <div id="file-list" style="margin-top:8px;font-size:13px;color:#333;"></div>
    </div>
  ...
  const processExtra = (isHome || isContact) ? `
    <div id="home-process-extra" class="home-process-extra" style="display:none;">
      ...
      <div class="form-group">
        ...
        <div class="file-upload-area" onclick="this.querySelector('input').click()">
          <input type="file" id="home-file-input" name="files" style="display:none;" multiple accept=".pdf,.doc,.docx">
